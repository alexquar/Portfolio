...
<template>
  ...
  <p class="text-lg mb-8">Here are some of my projects on <a href="https://github.com/alexquar" class="underline text-indigo-800">GitHub</a>, listed by creation date. Projects range from full stack apps and passion projects to smaller concepts pages. Each project is linked. I hope you enjoy having a look at my projects!</p>
