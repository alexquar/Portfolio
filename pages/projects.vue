...
<template>
  ...
  <p class="text-lg mb-8">Here are some of my projects on GitHub, listed by data. Projects range from full stack apps and passion projects to smaller concepts pages. Each project is linked. I hope you enjoy!</p>
