<template>
    <div class="relative h-[575px] w-[304px]">
      <!-- Image -->
      <img class="rounded-3xl h-full w-full" :src="images[count]" />
      <!-- Top-left button -->
      <button
        @click="count = (count - 1 + images.length) % images.length"
      ...
      <!-- Top-right button -->
      <button
      @click="count = (count + 1) % images.length"
